...
function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      desc: "Создание сюжетов, диалогов, лора и нарративных механик для игровых проектов. Проработанные персонажи, ветвящиеся диалоги и атмосферные описания под стиль вашей игры.",
      stack: ["Нарративный дизайн", "Геймдизайн", "Сценарий", "Лор"],
    ...
    },
    {
      ...
      desc: "Разработка современных сайтов: лендинги, корпоративные сайты, каталоги. Адаптивная вёрстка, быстрая загрузка, подключение форм и базовое SEO. Сдача в срок.",
